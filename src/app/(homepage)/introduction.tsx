  ...
  return (
    <div className="flex flex-col items-center gap-16">
        ...
        <div className="flex justify-center">
          <PrettyFrame className="p-zero !bg-[#11111B]">
            <img
              ...
              width={224}
              height={224}
              className="max-sm:bg-[url(/homepage/doodles/dark/intro_altern.svg)]"
            />
            <Doodle
              alt="Doodle of me gripping the logo"
              src={`/homepage/doodles/${theme}/intro.svg`}
              posx="left"
              posy="top"
              dx={-150}
              dy={-80}
      ...
      <p className="w-full">
        ...
        <br />
        No pages but the homepage have been completed so far.
        <br />
