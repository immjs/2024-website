export default async function Page() {
  ...
  return (
    <body style={{ overflow: 'hidden' }}>
      ...
      <a href={randomLink[0]} target="_parent">
        <img src={randomLink[1]} style={{ width: '100vw', height: '100vh', objectFit: 'cover' }} />
      </a>
      <a href="https://dimden.dev/navlinkads/" target="_parent" style={{ border: '1px solid', bottom: 0, left: 0, fontSize: 10, padding: 2, fontFamily: 'serif', lineHeight: '1em', color: 'dimgray', position: 'absolute', backgroundColor: '#ffffffc0', borderRadius: "0 2px 0 0" }}>
        NavLink Ads
      </a>
    </body>
  );
